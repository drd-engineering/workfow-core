...
complete -c git-checkout -l recurse-submodules -l no-recurse-submodules --description 'Using --recurse-submodules will update the content of all initialized submodu…'
